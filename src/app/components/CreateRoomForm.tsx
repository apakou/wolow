...
export default function CreateRoomForm({ email }: { email: string }) {
    ...
    <main className="min-h-screen bg-app-gradient flex items-center justify-center px-4">
      <div className="w-full max-w-sm flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <a
            href="/my-rooms"
            className="text-center text-xs text-muted hover:text-slate-300 transition"
          >
            View my existing rooms →
          </a>
        </div>
      </div>
    </main>
